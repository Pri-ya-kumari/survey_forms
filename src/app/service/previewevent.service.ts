...
export class PrevieweventService {
  ...
  save(register :any){
    const requestUrl = `https://sheets.googleapis.com/v4/spreadsheets/1eGrsCdwKoVoRd8ABJ_KavHFOxJL4hGqWe-li-RaGFzc/values/${this.range}:append?valueInputOption=USER_ENTERED&alt=json&key=AIzaSyALyxDDNthFKzBatN-EH9vKNKcmJLyut4Y`;

    const requestBody ={
      values:[[register.fname,register.email,register.phone,register.op1.register.op2]]
    };
