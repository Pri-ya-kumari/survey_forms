...
export class HtcsjsComponent {
  ...
  form(){
    this.forms = this.fb.group({
      fname:['Example:Sam',Validators.required],
      lname:['Example:Singh',Validators.required],
      email: ['Sam@gmai.com', [Validators.required,
      Validators.pattern("^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$")] ],
      phone: ['1234567890', [Validators.required, Validators.pattern("^((\\+91-?)|0)?[0-9]{10}$")]] ,
